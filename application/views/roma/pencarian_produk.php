        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Pencarian Produk</li>
...
<div class="container py-3">
    <div class="row">
        <div class="col-md-12 align-center">
            <h5 class="text-center text-info">Hasil Pencarian</h5>
...
<?php } ?>
        ...
        <div class="col-md-9">
            ...
            <?php if(count($cari_produk)>0) { ?>
				<?php foreach ($cari_produk as $data) { ?>
                ...
                <?php } ?>
        <?php } else {?>
            <div class='alert alert-info'> Mohon maaf produk yang anda cari saat ini sedang kosong</div>
        <?php } ?>
            </div>
        </div>
    </div>
